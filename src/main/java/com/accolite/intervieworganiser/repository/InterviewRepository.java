...
public interface InterviewRepository extends JpaRepository<Interview, Integer> {
    ...
    @Query(value = "Select a.name as organiser, " +
        ...
        nativeQuery = true)
    List<com.accolite.intervieworganiser.dto.Interview> findAllByInterviewer(@Param("userId") Integer userId, @Param("date") LocalDate minDate);
        ...
        "from " +
            ...
            "from " +
                ...
                "from " +
                    ...
                    "ON interviewInfo.organiser_id = a.user_id;",
        nativeQuery = true)
    List<com.accolite.intervieworganiser.dto.Interview> findAllByRecruiter(@Param("userId") Integer userId, @Param("date") LocalDate minDate);
            ...
            "from " +
                ...
                "from " +
                    ...
                    "from " +
                        ...
                        "ON interviewInfo.organiser_id = a.user_id;",
            nativeQuery = true)
    List<com.accolite.intervieworganiser.dto.Interview> findByStatus(@Param("userId") Integer userId, @Param("status") String status,
            ...
            "from " +
                ...
                "from " +
                    ...
                    "from " +
                        ...
                        "ON interviewInfo.organiser_id = a.user_id;",
        nativeQuery = true)
    List<com.accolite.intervieworganiser.dto.Interview> findByOutcome(@Param("userId") Integer userId,
                                                                      @Param("date") LocalDate minDate,
